...
void runTest(char* files, int size, void* handle){

    MainTable* (*createMainTable)() = dlsym(handle,"createMainTable");
    SequenceOfPairs* (*defineSequenceOfPairOfFiles)() = dlsym(handle,"defineSequenceOfPairOfFiles");
    FILE* (*merge)() = dlsym(handle,"merge");
    void (*addBlock)() = dlsym(handle,"addBlock");
    void (*deleteBlock)() = dlsym(handle,"deleteBlock");
...
int main(int argc, char **argv)
{
    ...
    void (*addBlock)() = dlsym(handle,"addBlock");
    void (*deleteBlock)() = dlsym(handle,"deleteBlock");
    void (*deleteRow)() = dlsym(handle,"deleteRow");
    void (*cleanPairs)() = dlsym(handle,"cleanPairs");
    void (*clean)() = dlsym(handle,"clean");



    if(argc == 4 && strcmp(argv[1], "test") == 0){
        runTest(argv[2], atoi(argv[3]), handle);
    }
